...
class sha512(sha):
	...
	def digest(self, p):
		...
		for b in m:
			...
			print(self.H)
			d = sum(c << 64*(len(self.H) - i - 1) for i, c in enumerate(self.H))
			return d

s = sha512()
x = """asdf"""*27
print(x)
print(s.parse(0xA0E1C33803602FC27AC1B0BB68999FF02BDB87AE7CEDCF43B55BDB345B82A7397033D0B0C166AA03F0B87286A1CD57D813B1848DC1BB783AEDAD2A3B9FF69C43, 64))
# x = 'asdf'
print(hex(s(x)))